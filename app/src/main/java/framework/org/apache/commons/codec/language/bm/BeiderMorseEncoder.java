...
package framework.org.apache.commons.codec.language.bm;
...
public class BeiderMorseEncoder implements StringEncoder {
    ...
    public Object encode(final Object source) throws framework.org.apache.commons.codec.EncoderException {
        if (!(source instanceof String)) {
            throw new framework.org.apache.commons.codec.EncoderException("BeiderMorseEncoder encode parameter is not of type String");
        }
        return encode((String) source);
    }

    @Override
    public String encode(final String source) throws framework.org.apache.commons.codec.EncoderException {
        if (source == null) {
            return null;
        }
