...
public final class HmacUtils {
    ...
    public static String hmacMd5Hex(final byte[] key, final byte[] valueToDigest) {
        return framework.org.apache.commons.codec.binary.Hex.encodeHexString(hmacMd5(key, valueToDigest));
    }
    ...
    public static String hmacSha1Hex(final byte[] key, final byte[] valueToDigest) {
        return framework.org.apache.commons.codec.binary.Hex.encodeHexString(hmacSha1(key, valueToDigest));
    }
...
s     * @throws IllegalArgumentException
    ...
    public static String hmacSha256Hex(final byte[] key, final byte[] valueToDigest) {
        return framework.org.apache.commons.codec.binary.Hex.encodeHexString(hmacSha256(key, valueToDigest));
    }
    ...
    public static String hmacSha384Hex(final byte[] key, final byte[] valueToDigest) {
        return framework.org.apache.commons.codec.binary.Hex.encodeHexString(hmacSha384(key, valueToDigest));
    }
    ...
    public static String hmacSha512Hex(final byte[] key, final byte[] valueToDigest) {
        return framework.org.apache.commons.codec.binary.Hex.encodeHexString(hmacSha512(key, valueToDigest));
    }
